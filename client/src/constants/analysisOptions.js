...
export class ANALYSIS_OPTIONS {
    ...
    static GROUP_SEG_SIZE_STD = "Standard Deviation Over Time";
    ...
    static GROUP_SEG_SHAPE_STD = "Standard Deviation Over Time";
    ...
    static GROUP_SEG_POINTINESS_STD = "Standard Deviation Over Time";
